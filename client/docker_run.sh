...
docker run \
    ...
    -e XAUTHORITY=$XAUTH \
    -v "$XAUTH:$XAUTH" \
    -v "/home/$USER/vitis-ai-socket-inference/client:/home/argsubt/vitis-ai-socket-inference/client" \
    -v "/tmp/.X11-unix:/tmp/.X11-unix" \
    -v "/etc/localtime:/etc/localtime:ro" \
    -v "/dev:/dev" \
    -v "/var/run/docker.sock:/var/run/docker.sock" \
    -v "/home/$USER/.bashrc:/home/argsubt/.bashrc" \
    --workdir "/home/argsubt/vitis-ai-socket-inference/client" \
    --name argsubt \
    --network host \
    --privileged \
    --security-opt seccomp=unconfined \
    $DOCKER_OPTS \
    argnctu/pokingbot-rl:husky \
    bash
