...
echo_and_run cd "/home/argsubt/vitis-ai-socket-inference/client/catkin_ws/src/vision_opencv/cv_bridge"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/argsubt/vitis-ai-socket-inference/client/catkin_ws/src/vision_opencv/cv_bridge/setup.py" \
     \
    build --build-base "/home/argsubt/vitis-ai-socket-inference/client/catkin_ws/build/vision_opencv/cv_bridge" \
    install \
    --root="${DESTDIR-/}" \
